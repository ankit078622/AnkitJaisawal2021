...
public class StudentManager {
	...
	public static void main(String args[]) {
	    ...
	    Integer studentDetails1 = studentServices.addStudent("Ankit","Full Stack",15000);// asssinged values from here
		Integer studentDetails2 = studentServices.addStudent("Mahesh","Java",12000);// asssinged values from here
