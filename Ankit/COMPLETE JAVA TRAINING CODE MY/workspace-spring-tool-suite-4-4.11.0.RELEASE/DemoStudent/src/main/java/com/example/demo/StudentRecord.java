...
public class StudentRecord {
	...
	public StudentRecord(){
		...
		if (StudentIdMap == null) {
			...
			Student indiaStudent = new Student(1, "Ravi", "M", "delhi",1000);
			Student chinaStudent = new Student(2, "Anand", "M", "delhi",5000);
			Student nepalStudent = new Student(3, "Alok", "M", "delhi",12000);
			Student bhutanStudent = new Student(4, "Ashutosh", "M", "delhi",15000);
